...
Route::get('accept_offer/{id}','\App\Http\Controllers\Account\MessagesController@accept_offer')->name('accept_offer');
Route::get('reject_offer/{id}','\App\Http\Controllers\Account\MessagesController@reject_offer')->name('reject_offer');
...
|
*/
Route::get('/get_package_detail', 'App\Http\Controllers\Admin\LimitPackageController@get_package_detail')->name('get_package_detail');
Route::group([
	...
	Route::group([
		...
		// Dashboard
        Route::get('limit-package', 'LimitPackageController@getPackages');
        Route::post('create-package', 'LimitPackageController@create');
        Route::post('update-package', 'LimitPackageController@update');
        Route::get('delete-package', 'LimitPackageController@delete');
        Route::get('update-status', 'LimitPackageController@change_status');
...
Route::group([
	...
	Route::group(['middleware' => ['web', 'install.checker']], function ($router) {
        ...
        Route::post('bannerDelete','HomeController@bannerDelete')->name('bannerDelete');

        //message Request
        Route::post('sendRequest','MessageRequestController@create')->name('sendRequest');
        Route::get('messageRequest','MessageRequestController@index');
        Route::post('messageApprove','MessageRequestController@messageApprove')->name('messageApprove');
        Route::post('messageDecline','MessageRequestController@messageDecline')->name('messageDecline');

        //rent Scheduler
        Route::post('setRent','RentController@create')->name('setRent');
        Route::post('deleteRent','RentController@deleteRent')->name('deleteRent');
        Route::get('get_rent_data','RentController@get_rent_data')->name('get_rent_data');
...
Route::post('/save_reply', '\App\Http\Controllers\Rating@save_reply')->name('save_reply');
Route::post('rating-save/{id}/{gift_id}', '\App\Http\Controllers\Rating@store')->name('rating-save');
Route::post('rating-save-reviewer/{id}/{gift_id}', '\App\Http\Controllers\Rating@store_reviewer')->name('rating-save-reviewer');
Route::get('footer-above-section', '\App\Http\Controllers\HomeController@footerImages')->name('footr-banner');
Route::post('footer-above-section', '\App\Http\Controllers\HomeController@footerImages_save')->name('footr-update');

Route::get('profile/details/{id}', '\App\Http\Controllers\HomeController@profileDetails')->name('profile.details');
