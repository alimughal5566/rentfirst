<?php if(isset($parent) and !empty($parent)): ?>
	...
	<?php if(isset($parent->children) and $parent->children->count() > 0): ?>
		<a href="#browseCategories" data-toggle="modal" class="cat-link" data-id="<?php echo e($parent->id); ?>">
	...
	<?php else: ?>
		...
		[ <a href="#browseCategories"
			 data-toggle="modal"
			 class="cat-link"
			 data-id="<?php echo e((isset($parent->parent) and !empty($parent->parent)) ? $parent->parent->id : 0); ?>"
		><i class="far fa-edit"></i> <?php echo e(t('Edit')); ?></a> ]
	<?php endif; ?>
<?php endif; ?><?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/post/createOrEdit/inc/category/parent.blade.php ENDPATH**/ ?>