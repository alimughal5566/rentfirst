		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-12 page-content">
					<div class="inner-box category-content add_custon_padding">
						<h2 class="title-2">
								...
								<form class="form-horizontal" id="postForm" method="POST" action="<?php echo e(request()->fullUrl()); ?>" enctype="multipart/form-data">
									...
									<fieldset>
										...
										<div class="form-group row required">
											<label class="col-md-2 col-form-label<?php echo e($categoryIdError); ?>"><?php echo e(t('category')); ?> <sup>*</sup></label>
											<div class="col-md-10">
												<div id="catsContainer" class="rounded">
													<a href="#browseCategories" data-toggle="modal" class="cat-link d-block" data-id="0">
														<?php echo e(t('select_a_category')); ?>

													</a>
													<?php if(isset(auth()->user()->id)): ?>
														<input type="hidden" name="cat_user_id" value="<?php echo e(auth()->user()->id); ?>">
													<?php endif; ?>
												</div>
											</div>
										...
										<?php if(config('settings.single.show_post_types')): ?>
											...
											<?php if(isset($postTypes)): ?>
												...
												<div id="postTypeBloc" class="form-group row required">
													<label class="col-md-2 col-form-label"><?php echo e(t('type')); ?> <sup>*</sup></label>
													<div class="col-md-10">
														...
														<div class="form-check form-check-inline pt-2">
															<input name="post_type_id"
																id="postTypeId-<?php echo e($postType->id); ?>"
																value="<?php echo e($postType->id); ?>"
																type="radio"
																class="form-check-input<?php echo e($postTypeIdError); ?>"
																<?php echo e((old('post_type_id')==$postType->id) ? ' checked="checked"' : ''); ?>

															>
															<label class="form-check-label" for="postTypeId-<?php echo e($postType->id); ?>">
										...
										<div class="form-group row required">
											<label class="col-md-2 col-form-label" for="title"><?php echo e(t('title')); ?> <sup>*</sup></label>
											<div class="col-md-10">
										...
										<div class="form-group row required">
											...
											?>
											<label class="col-md-2 col-form-label<?php echo e($descriptionErrorLabel); ?>" for="description">
										...
										<div id="priceBloc" class="form-group row">
											<label class="col-md-2 col-form-label" for="price"><?php echo e(t('price')); ?></label>
											<div class="col-md-10">
												...
												<small id="" class="form-text text-muted"><?php echo e(t('price_hint')); ?></small>
											</div>
										</div>
										...
										<?php if(empty(config('country.code'))): ?>
											<div class="form-group row required">
												<label class="col-md-2 col-form-label<?php echo e($countryCodeError); ?>" for="country_code"><?php echo e(t('your_country')); ?> <sup>*</sup></label>
												<div class="col-md-10">
										...
										*/
										...
										<?php if(config('country.admin_field_active') == 1 and in_array(config('country.admin_type'), ['1', '2'])): ?>
											...
											<div id="locationBox" class="form-group row required">
												<label class="col-md-2 col-form-label<?php echo e($adminCodeError); ?>" for="admin_code"><?php echo e(t('location')); ?> <sup>*</sup></label>
												<div class="col-md-10">
										...
										<div id="cityBox" class="form-group row required">
											<label class="col-md-2 col-form-label<?php echo e($cityIdError); ?>" for="city_id"><?php echo e(t('city')); ?> <sup>*</sup></label>
											<div class="col-md-10">
										...
										<div class="form-group row">
											<label class="col-md-2 col-form-label" for="tags"><?php echo e(t('Tags')); ?></label>
											<div class="col-md-10">
												<input id="tags"
													   name="tags"
										...
										<?php else: ?>
											<div class="form-group row required">
												<label class="col-md-2 col-form-label" for="contact_name"><?php echo e(t('your_name')); ?> <sup>*</sup></label>
												<div class="col-md-10">
										...
										<div class="form-group row required">
											<label class="col-md-2 col-form-label" for="phone"><?php echo e(t('phone_number')); ?>
										...
										<div class="form-group row required">
											<label class="col-md-2 col-form-label" for="email"><?php echo e(t('email')); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/post/createOrEdit/multiSteps/create.blade.php ENDPATH**/ ?>