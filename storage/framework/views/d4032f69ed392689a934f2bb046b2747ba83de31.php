    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#description').summernote({
                ...
                placeholder: '<?php echo e(t('describe_what_makes_your_ad_unique')); ?>...',
                tabsize: 2,
                height: 350,
                toolbar: [
                    ['style', ['style']],
...
<?php endif; ?>
<?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/layouts/inc/tools/wysiwyg/js.blade.php ENDPATH**/ ?>