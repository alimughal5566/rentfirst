                                                    ...
                                                    <div id="chatform_d">
                                                        <div id="chat_form_fields" >
                                                            ...
                                                            <textarea id="body"
                                                                  ...
                                                                  style="{{ (config('lang.direction')=='rtl') ? 'padding-left' : 'padding-right' }}: 75px;"></textarea>
...
{{--                                                                @else--}}
{{--                                                                    <a onclick="request_offer()" id="request_offer" class="btn btn-primary" >--}}
...
{{--                                                    <div class="make_an_offer" id="make_an_offer" style="display: none;">--}}
