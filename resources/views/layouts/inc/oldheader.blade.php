                    ...
                    @if (!auth()->check())
                        <li class="nav-item">
                            @if (config('settings.security.login_open_in_modal'))
                                <a href="#quickLogin" class="nav-link" data-toggle="modal">
                                    <i class="icon-user"></i> {{ t('log_in') }}</a>
                            @else
                        ...
                        <li class="nav-item hidden-sm">
                            <a href="{{ \App\Helpers\UrlGen::register() }}" class="nav-link">
                                <i class="icon-user-add"></i> {{ t('register') }}</a>
                        </li>
                    @else
                        <li class="nav-item hidden-sm">
                                    ...
                                    @if(!$check->isEmpty())
                                        <li class="dropdown-item">
                                            ...
                                            <a href="#" data-toggle="modal" data-target="#exampleModal">
                                                <i class="icon-mail-1"></i> Message Requests
