						...
						<div class="row">
							<div class="col-md-5 col-xs-4 col-xxs-12">
								<h3 class="no-padding text-center-480 useradmin">
									<a href="">
										<img id="userImg" class="userImg" src="<?php echo e($user->photo_url); ?>" alt="user">&nbsp;
										...
										<div class="mcol-right">
											...
											<p>
												<a href="<?php echo e(url('account/messages')); ?>">
													<?php echo e(isset($countThreads) ? \App\Helpers\Number::short($countThreads) : 0); ?>

													<em><?php echo e(trans_choice('global.count_mails', getPlural($countThreads))); ?></em>
												</a>
											</p>
										</div>
					...
					<div class="inner-box default-inner-box">
						<div class="welcome-msg">
							...
							<span class="page-sub-header-sub small">
                                <?php echo e(t('You last logged in at')); ?>: <?php echo e(\App\Helpers\Date::format($user->last_login_at, 'datetime')); ?>
						...
						<div id="accordion" class="panel-group">
							...
							<div class="card card-default">
								...
								<div class="panel-collapse collapse <?php echo e((old('panel')=='' or old('panel')=='photoPanel') ? 'show' : ''); ?>" id="photoPanel">
									<div class="card-body">
										<form name="details" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('account/' . $user->id . '/photo')); ?>">
											<div class="row">
                                                        ...
                                                        <?php $__currentLoopData = $genders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gender): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<div class="form-check form-check-inline pt-2">
																<input name="gender_id"
																	   id="gender_id-<?php echo e($gender->id); ?>"
																	   value="<?php echo e($gender->id); ?>"
																	   class="form-check-input<?php echo e($genderIdError); ?>"
																	   type="radio" <?php echo e((old('gender_id', $user->gender_id)==$gender->id) ? 'checked="checked"' : ''); ?>

																>
																<label class="form-check-label" for="gender_id-<?php echo e($gender->id); ?>">
							...
							<div class="card card-default">
								...
								<div class="panel-collapse collapse <?php echo e((old('panel')=='settingsPanel') ? 'show' : ''); ?>" id="settingsPanel">
									<div class="card-body">
										<form name="settings" class="form-horizontal" role="form" method="POST" action="<?php echo e(url('account/settings')); ?>">
											<?php echo csrf_field(); ?>
											...
											<?php if($user->accept_terms != 1): ?>
													...
													<div class="col-md-9">
														<div class="form-check">
															<input name="accept_terms" id="acceptTerms"
																   ...
																   value="1"
																   type="checkbox" <?php echo e((old('accept_terms', $user->accept_terms)=='1') ? 'checked="checked"' : ''); ?>
												...
												<input type="hidden" name="user_accept_terms" value="<?php echo e((int)$user->accept_terms); ?>">
											<?php endif; ?>
												...
												<div class="col-md-9">
													<div class="form-check">
														<input name="accept_marketing_offers" id="acceptMarketingOffers"
															   ...
															   value="1"
															   type="checkbox" <?php echo e((old('accept_marketing_offers', $user->accept_marketing_offers)=='1') ? 'checked="checked"' : ''); ?>
											...
											<div class="form-group row required">
												...
												<div class="col-md-9">
													<select name="time_zone" class="form-control sselecter<?php echo e($timeZoneError); ?>">
														<option value="" <?php echo e((empty(old('time_zone'))) ? 'selected="selected"' : ''); ?>>
														...
														<?php $__currentLoopData = \App\Helpers\Date::getTimeZones(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
															<option value="<?php echo e($key); ?>" <?php echo e((old('time_zone', $tz)==$key) ? 'selected="selected"' : ''); ?>>
																<?php echo e($item); ?>
													...
													<small id="" class="form-text text-muted">
														<?php if(auth()->user()->can(\App\Models\Permission::getStaffPermissions())): ?>
...
<?php $__env->startSection('after_scripts'); ?>
	...
	<script>
		...
		$('#photoField').fileinput(
		{
			...
			uploadUrl: '<?php echo e(url('account/' . $user->id . '/photo')); ?>',
			uploadAsync: false,
			showBrowse: false,
			showCancel: true,
			showUpload: false,
			...
			initialPreviewConfig: [
				{
					...
					<?php if(isset($user->photo) and !empty($user->photo)): ?>
						...
						url: '<?php echo e(url('account/' . $user->id . '/photo/delete')); ?>',
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/account/edit.blade.php ENDPATH**/ ?>