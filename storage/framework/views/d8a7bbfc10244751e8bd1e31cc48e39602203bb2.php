<?php if(isset($hasChildren) and !$hasChildren): ?>
	...
	<?php if(isset($category) and !empty($category)): ?>
		...
		<?php if(isset($category->children) and $category->children->count() > 0): ?>
			<a href="#browseCategories" data-toggle="modal" class="cat-link" data-id="<?php echo e($category->id); ?>">
		...
		<?php else: ?>
			...
			[ <a href="#browseCategories"
				 data-toggle="modal"
				 class="cat-link"
				 data-id="<?php echo e((isset($category->parent) and !empty($category->parent)) ? $category->parent->id : 0); ?>"
					...
					<?php if(isset($categories) and $categories->count() > 0): ?>
						<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 f-category">
								<a href="#" class="cat-link" data-id="<?php echo e($cat->id); ?>">
											...
											<?php $__currentLoopData = $cols; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												...
												<div class="cat-list">
													<h3 class="cat-title rounded">
														...
														<?php endif; ?>
														<a href="#" class="cat-link" data-id="<?php echo e($iCat->id); ?>">
													...
													<ul class="cat-collapse collapse show cat-id-<?php echo e($iCat->id . $randomId); ?> long-list-home">
														<?php if(isset($subCategories) and $subCategories->has($iCat->id)): ?>
															<?php $__currentLoopData = $subCategories->get($iCat->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iSubCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
																<li>
																	<a href="#" class="cat-link" data-id="<?php echo e($iSubCat->id); ?>">
...
<?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/post/createOrEdit/inc/category/select.blade.php ENDPATH**/ ?>