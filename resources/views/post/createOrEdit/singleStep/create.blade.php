                                    ...
                                    <!-- title -->
                                        ...
                                        <div class="form-group row required">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <small id=""
                                                       class="form-text text-muted">{{ t('a_great_title_needs_at_least_60_characters') }}</small>
                                            </div>
                                        </div>
                                        ...
                                        <!-- pictures -->
                                            ...
                                            <div class="form-group row required" id="picturesBloc">
                                                <label class="col-md-3 col-form-label{{ $picturesError }}"
                                                       for="pictures">
                                                    {{ t('pictures') }}
                                        ...
                                        @if (empty(config('country.code')))
                                            <div class="form-group row required">
                                                <label class="col-md-3 col-form-label{{ $countryCodeError }}"
                                                       for="country_code">{{ t('your_country') }} <sup>*</sup></label>
                                                <div class="col-md-8">
                                                ...
                                                @if (config('settings.single.auto_registration') == 1)
                                                    ...
                                                    <div class="form-group row required">
                                                        ...
                                                        <div class="col-md-8">
                                                            ...
                                                            <small id=""
                                                                   class="form-text text-muted">{{ t('You will receive your authentication information by email') }}</small>
                                                            <div style="clear:both"></div>
                                                        </div>
                                                    </div>
                                                @else
