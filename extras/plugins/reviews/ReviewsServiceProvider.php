...
//            'prefix'     => \LaravelLocalization::setLocale(),
        ...
        // Admin
        $router->group(['namespace' => 'extras\plugins\reviews\app\Http\Controllers\Admin'], function ($router) {
            Route::group([
    ...
    public function registerAdminMiddleware(Router $router)
    {
		...
		Route::aliasMiddleware('localize', \App\Http\Middleware\Admin::class);
		Route::aliasMiddleware('localizationRedirect', \App\Http\Middleware\Admin::class);
		Route::aliasMiddleware('localeSessionRedirect', \App\Http\Middleware\Admin::class);
    }
}
