		...
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title uppercase font-weight-bold" id="selectCountryLabel">
					<i class="icon-map"></i> <?php echo e(t('Select a Country')); ?>
							...
							<ul class="cat-list col-xl-3 col-lg-3 col-md-4 col-sm-6 col-xs-6">
								...
								<li>
									<img src="<?php echo e(url('images/blank.gif') . getPictureVersion()); ?>"
										 class="flag flag-<?php echo e(($country->get('icode')=='uk') ? 'gb' : $country->get('icode')); ?>"
										 style="margin-bottom: 4px; margin-right: 5px;"
									>
									<a href="<?php echo e(dmUrl($country, '/', true, true)); ?>" class="tooltip-test" title="<?php echo e($country->get('name')); ?>">
...
<?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/layouts/inc/modal/change-country.blade.php ENDPATH**/ ?>