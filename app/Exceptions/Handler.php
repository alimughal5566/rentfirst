...
//        dd($e);
		...
		if ($e instanceof \PDOException) {
			...
			if (in_array($e->getCode(), $tableErrorCodes['mysql']) or in_array($e->getCode(), $tableErrorCodes['standardized'])) {
				...
				$msg .= '<br>3/ Delete the installation backup file at: <code>/storage/installed</code> (required before re-installation)';
				$msg .= '<br>4/ and reload this page -or- go to install URL: <a href="' . url('install') . '">' . url('install') . '</a>.';
				$msg .= '<br>';
