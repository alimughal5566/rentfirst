                                        ...
                                        <div class="form-group">
                                            <div class="col-md-12 text-center mt-4">
                                                @if (request()->segment(2) == 'create')
                                                    <a id="skipBtn" href="{{ url('posts/create/' . $post->tmp_token . '/finish') }}" class="btn btn-primary-revert btn-lg">
					                                             Submit
							                                      </a>
                                                @else
                                                    <a id="skipBtn" href="{{ \App\Helpers\UrlGen::post($post) }}" class="btn btn-primary-revert btn-lg">
                          														 Submit
                          													</a>
                                                @endif
                                                <button style="display: none;" id="submitPostForm" class="btn btn-primary btn-lg submitPostForm"> {{ t('Pay') }} </button>
                                            </div>
                                        </div>
