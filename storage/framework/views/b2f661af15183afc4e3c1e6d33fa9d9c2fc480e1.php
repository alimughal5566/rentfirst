						...
						<div class="col-sm-6 no-padding">
							<form id="modalAdminForm" name="modalAdminForm" method="POST">
								<input type="hidden"
									   id="currSearch"
									   name="curr_search"
									   value="<?php echo base64_encode(serialize(request()->except(['l', 'location', '_token']))); ?>"
								>
...
<?php $__env->stopSection(); ?><?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/layouts/inc/modal/location.blade.php ENDPATH**/ ?>