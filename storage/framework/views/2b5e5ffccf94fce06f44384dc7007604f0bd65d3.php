            ...
            <div class="row">
                ...
                <?php if(config('settings.footer.hide_powered_by') != '1'): ?>
                    <div class="col-md-6 text-right">
                        ...
                        <?php else: ?>
                            <?php echo e(trans('admin.powered_by')); ?> <a target="_blank" href="https://www.ivylabtech.com">IVYLAB TECHNOLOGIES</a>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </div>
...
</html><?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/vendor/admin/layouts/master.blade.php ENDPATH**/ ?>