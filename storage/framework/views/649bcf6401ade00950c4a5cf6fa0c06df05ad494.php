							...
							<?php if(!in_array($uriPath, ['finish'])): ?>
								<li class="<?php echo e(($uriPath == '') ? 'active' : (in_array($uriPath, ['photos', 'packages', 'finish']) or (isset($post) and !empty($post)) ? '' : 'disabled')); ?>">
									<?php if(isset($post) and !empty($post)): ?>
										<a href="<?php echo e(url('posts/create/' . $post->tmp_token)); ?>"><?php echo e(t('ad_details')); ?></a>
									<?php else: ?>
										<a href="<?php echo e(url('posts/create')); ?>"><?php echo e(t('ad_details')); ?></a>
									<?php endif; ?>
								</li>
								...
								<li class="picturesBloc <?php echo e(($uriPath == 'photos') ? 'active' : ((in_array($uriPath, ['photos', 'packages', 'finish']) or (isset($post) and !empty($post))) ? '' : 'disabled')); ?>">
									<?php if(isset($post) and !empty($post)): ?>
										<a href="<?php echo e(url('posts/create/' . $post->tmp_token . '/photos')); ?>"><?php echo e(t('Photos')); ?></a>
									<?php else: ?>
								...
								<li class="<?php echo e(($uriPath == 'payment') ? 'active' : ((in_array($uriPath, ['finish']) or (isset($post) and !empty($post))) ? '' : 'disabled')); ?>">
									<?php if(isset($post) and !empty($post)): ?>
										<a href="<?php echo e(url('posts/create/' . $post->tmp_token . '/payment')); ?>"><?php echo e(t('Payment')); ?></a>
									<?php else: ?>
                        ...
                        <?php else: ?>
							...
							<?php if(!in_array($uriPath, ['finish'])): ?>
								<li class="<?php echo e((in_array($uriPath, [null, 'edit'])) ? 'active' : ''); ?>">
									<?php if(isset($post) and !empty($post)): ?>
										<a href="<?php echo e(url('posts/' . $post->id . '/edit')); ?>"><?php echo e(t('ad_details')); ?></a>
									<?php else: ?>
										<a href="<?php echo e(url('posts/create')); ?>"><?php echo e(t('ad_details')); ?></a>
									<?php endif; ?>
								</li>
								...
								<li class="picturesBloc <?php echo e(($uriPath == 'photos') ? 'active' : ''); ?>">
									<?php if(isset($post) and !empty($post)): ?>
										<a href="<?php echo e(url('posts/' . $post->id . '/photos')); ?>"><?php echo e(t('Photos')); ?></a>
									<?php else: ?>
										<a><?php echo e(t('Photos')); ?></a>
									<?php endif; ?>
								</li>
								...
								<li class="<?php echo e(($uriPath == 'payment') ? 'active' : ''); ?>">
									<?php if(isset($post) and !empty($post)): ?>
										<a href="<?php echo e(url('posts/' . $post->id . '/payment')); ?>"><?php echo e(t('Payment')); ?></a>
									<?php else: ?>
										<a><?php echo e(t('Payment')); ?></a>
									<?php endif; ?>
								</li>
...
<?php $__env->stopSection(); ?><?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/post/createOrEdit/multiSteps/inc/wizard.blade.php ENDPATH**/ ?>