						...
						<ul class="dropdown-user list-style-none">
							<li>
								<div class="dw-user-box p-3 d-flex">
									<div class="u-img">
										<img src="<?php echo e(auth()->user()->photo_url); ?>" alt="" class="rounded" width="80">
									</div>
...
<?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/vendor/admin/layouts/inc/header.blade.php ENDPATH**/ ?>