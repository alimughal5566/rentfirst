                    ...
                    <div class="large-12 columns">
                        <div class="no-margin featured-list-slider owl-carousel owl-theme">
                            @foreach($featured->posts as $key => $post)
                                ...
                                ?>
                                <div class="item">
                                    <a href="{{ \App\Helpers\UrlGen::post($post) }}" class="p-0">
...
{{--                                                        @dd($rent_date, date('Y-m-d h:i A'))--}}
											...
											<img class="img-fluid" src="{{ $postImg }}" alt="{{ $post->title }}">
										</span>
                                        <span class="item-carousel-desc px-2">
                                            ...
                                            <h4 class="item-name-wrap">{{ \Illuminate\Support\Str::limit($post->title, 70) }}</h4>
