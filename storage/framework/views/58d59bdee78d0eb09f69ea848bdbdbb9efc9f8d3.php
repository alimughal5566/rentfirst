    ...
    <div class="filter-date filter-content">
        <ul>
            ...
            <input type="hidden" id="postedQueryString"
                   value="<?php echo e(httpBuildQuery(request()->except(['page', 'postedDate']))); ?>">
        </ul>
    </div>
</div>
...
<?php $__env->stopSection(); ?><?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/search/inc/sidebar/date.blade.php ENDPATH**/ ?>