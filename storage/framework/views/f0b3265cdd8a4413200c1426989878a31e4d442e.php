                    ...
                    <div class="inner">
                        <h2>
                            <span class="title-3"><?php echo e(t('Browse by')); ?> <span
                                        style="font-weight: bold;"><?php echo e(t('category')); ?></span></span>
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 f-category">
                                <a href="<?php echo e(\App\Helpers\UrlGen::category($cat)); ?>">
                                    <img src="<?php echo e(imgUrl($cat->picture, 'cat')); ?>" class="lazyload img-fluid"
                                         alt="<?php echo e($cat->name); ?>">
                                    <h6>
                                        <?php echo e($cat->name); ?>

                                        <?php if(config('settings.listing.count_categories_posts')): ?>
                                            &nbsp;(<?php echo e($countPostsByCat->get($cat->id)->total ?? 0); ?>)
                                        <?php endif; ?>
                                    </h6>
                                </a>
                            </div>
                                                ...
                                                <div class="cat-list">
                                                    <h3 class="cat-title rounded">
                                                        ...
                                                        <a href="<?php echo e(\App\Helpers\UrlGen::category($iCat)); ?>">
                                                            ...
                                                            <?php if(config('settings.listing.count_categories_posts')): ?>
                                                                &nbsp;
                                                                (<?php echo e($countPostsByCat->get($iCat->id)->total ?? 0); ?>)
                                                            <?php endif; ?>
                                                        </a>
                                                        ...
                                                        <?php if(isset($subCategories) and $subCategories->has($iCat->id)): ?>
                                                            <?php $__currentLoopData = $subCategories->get($iCat->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iSubCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <li>
                                                                    ...
                                                                    <?php if(config('settings.listing.count_categories_posts')): ?>
                                                                        &nbsp;
                                                                        (<?php echo e($countPostsByCat->get($iSubCat->id)->total ?? 0); ?>
...
<?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/home/inc/categories.blade.php ENDPATH**/ ?>