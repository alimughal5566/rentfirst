            ...
            <div class="modal-body">
               ...
               <div class="main_login_form">
                  ...
                  <div class="form-group">
                     <!-- <label for="mLogin"
                        class="control-label"><?php echo e(t('login') . ' (' . getLoginLabel() . ')'); ?></label> -->
...
</script><?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/layouts/inc/modal/login.blade.php ENDPATH**/ ?>