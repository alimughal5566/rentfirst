                    ...
                    <?php if(!config('settings.footer.hide_links')): ?>
                        <div class="<?php echo e($colClass1); ?>">
                            <div class="footer-col">
                                <h4 class="footer-title d-flex align-items-center"><?php echo e(t('about_us')); ?></h4>
                            </div>
                        </div>
                        <div class="<?php echo e($colClass2); ?>">
                            <div class="footer-col">
                                <h4 class="footer-title d-flex align-items-center"><?php echo e(t('Contact and Sitemap')); ?></h4>
                            </div>
                        </div>
                        <div class="<?php echo e($colClass3); ?>">
                            <div class="footer-col">
                                <h4 class="footer-title d-flex align-items-center"><?php echo e(t('My Account')); ?></h4>
                            </div>
                        </div>
                        <div class="<?php echo e($colClass4); ?>">
                            ...
                            <div class="<?php echo $footerSocialClass; ?>">
                                <h4 class="footer-title d-flex align-items-center <?php echo $footerSocialTitleClass; ?>"><?php echo e(t('Follow us on')); ?></h4>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <?php if(!config('settings.footer.hide_links')): ?>
                        <div class="<?php echo e($colClass1); ?>">
                            <div class="footer-col">
                                <h4 class="d-flex align-items-end d-md-none footer-title"><?php echo e(t('about_us')); ?></h4>
                                            ...
                                            <li>
                                                ...
                                                <?php if(!empty($page->external_link)): ?>
                                                    <a href="<?php echo $page->external_link; ?>"
                                                       rel="nofollow" <?php echo $linkTarget; ?>> <?php echo e($page->name); ?> </a>
                                                <?php else: ?>
                        ...
                        <div class="<?php echo e($colClass2); ?>">
                            <div class="footer-col">
                                <h4 class="d-flex align-items-end d-md-none footer-title"><?php echo e(t('Contact and Sitemap')); ?></h4>
                                <ul class="list-unstyled footer-nav">
                                    ...
                                    <?php if(isset($countries) && $countries->count() > 1): ?>
                                        <li><a href="<?php echo e(\App\Helpers\UrlGen::countries()); ?>"> <?php echo e(t('countries')); ?> </a>
                                        </li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                        ...
                        <div class="<?php echo e($colClass3); ?>">
                            <div class="footer-col">
                                <h4 class="d-flex align-items-end d-md-none footer-title"><?php echo e(t('My Account')); ?></h4>
                                <ul class="list-unstyled footer-nav">
                                    <?php if(!auth()->user()): ?>
                                        <li>
                                        ...
                                        <li><a href="<?php echo e(\App\Helpers\UrlGen::register()); ?>"> <?php echo e(t('register')); ?> </a>
                                        </li>
                                    <?php else: ?>
                                        <li><a href="<?php echo e(url('account')); ?>"> <?php echo e(t('Personal Home')); ?> </a></li>
                                        <li><a href="<?php echo e(url('account/my-posts')); ?>"> <?php echo e(t('my_ads')); ?> </a></li>
                                        <li><a href="<?php echo e(url('account/favourite')); ?>"> <?php echo e(t('favourite_ads')); ?> </a></li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div class="<?php echo e($colClass4); ?>">
                                <div class="footer-col row">
                                    ...
                                    <?php if(config('settings.other.ios_app_url') or config('settings.other.android_app_url')): ?>
                                        <div class="col-sm-12 col-xs-6 col-xxs-12 no-padding-lg">
                                            <div class="mobile-app-content">
                                                <h4 class="d-flex align-items-end d-md-none footer-title"><?php echo e(t('Mobile Apps')); ?></h4>
                                                <div class="row ">
                                                    <?php if(config('settings.other.ios_app_url')): ?>
                                                        <div class="col-xs-12 col-sm-6">
                                                            <a class="app-icon" target="_blank"
                                                               href="<?php echo e(config('settings.other.ios_app_url')); ?>">
                                                                <span class="hide-visually"><?php echo e(t('iOS app')); ?></span>
                                                                <img src="<?php echo e(url('images/site/app-store-badge.svg')); ?>"
                                                                     alt="<?php echo e(t('Available on the App Store')); ?>">
                                                            </a>
                                                        </div>
                                                    <?php endif; ?>
                                                    <?php if(config('settings.other.android_app_url')): ?>
                                                        <div class="col-xs-12 col-sm-6">
                                                            <a class="app-icon" target="_blank"
                                                               href="<?php echo e(config('settings.other.android_app_url')); ?>">
                                                                <span class="hide-visually"><?php echo e(t('Android App')); ?></span>
                                                                <img src="<?php echo e(url('images/site/google-play-badge.svg')); ?>"
                                                                     alt="<?php echo e(t('Available on Google Play')); ?>">
                                                            </a>
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                                    ...
                                    <?php if(
                                        ...
                                        <div class="col-sm-12 col-xs-6 col-xxs-12 no-padding-lg">
                                            <div class="<?php echo $footerSocialClass; ?>">
                                                <h4 class="d-flex align-items-end d-md-none footer-title <?php echo $footerSocialTitleClass; ?>"><?php echo e(t('Follow us on')); ?></h4>
                            ...
                            <div class="text-center paymanet-method-logo">
                                ...
                                <?php $__currentLoopData = $paymentMethods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paymentMethod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(file_exists(plugin_path($paymentMethod->name, 'public/images/payment.png'))): ?>
                                        <img src="<?php echo e(url('images/' . $paymentMethod->name . '/payment.png')); ?>"
...
<?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/layouts/inc/footer.blade.php ENDPATH**/ ?>