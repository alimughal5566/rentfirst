								...
								<form class="form-horizontal" id="postForm" method="POST" action="{{ request()->fullUrl() }}" enctype="multipart/form-data">
									...
									<fieldset>
										...
										<div class="form-group row required">
											<label class="col-md-2 col-form-label{{ $categoryIdError }}">{{ t('category') }} <sup>*</sup></label>
											<div class="col-md-10">
												<div id="catsContainer" class="rounded">
													...
													@if(isset(auth()->user()->id))
														<input type="hidden" name="cat_user_id" value="{{auth()->user()->id}}">
													@endif
												</div>
											</div>
										...
										@if (empty(config('country.code')))
											<div class="form-group row required">
												<label class="col-md-2 col-form-label{{ $countryCodeError }}" for="country_code">{{ t('your_country') }} <sup>*</sup></label>
												<div class="col-md-10">
										...
										*/
										...
										@else
											<div class="form-group row required">
												<label class="col-md-2 col-form-label" for="contact_name">{{ t('your_name') }} <sup>*</sup></label>
												<div class="col-md-10">
										...
										<div class="form-group row required">
											<label class="col-md-2 col-form-label" for="phone">{{ t('phone_number') }}
