<aside>
		...
		<div class="user-panel-sidebar">
			...
			<div class="collapse-box">
				...
				<div class="panel-collapse collapse show" id="MyClassified">
					<ul class="acc-list">
						<li>
							<a <?php echo ($pagePath=='') ? 'class="active"' : ''; ?> href="<?php echo e(url('account')); ?>">
			...
			<div class="collapse-box">
				...
				<div class="panel-collapse collapse show" id="MyAds">
					<ul class="acc-list">
						<li>
							<a<?php echo ($pagePath=='my-posts') ? ' class="active"' : ''; ?> href="<?php echo e(url('account/my-posts')); ?>">
						...
						<li>
							<a<?php echo ($pagePath=='favourite') ? ' class="active"' : ''; ?> href="<?php echo e(url('account/favourite')); ?>">
						...
						<li>
							<a<?php echo ($pagePath=='saved-search') ? ' class="active"' : ''; ?> href="<?php echo e(url('account/saved-search')); ?>">
						...
						<li>
							<a<?php echo ($pagePath=='pending-approval') ? ' class="active"' : ''; ?> href="<?php echo e(url('account/pending-approval')); ?>">
						...
						<li>
							<a<?php echo ($pagePath=='archived') ? ' class="active"' : ''; ?> href="<?php echo e(url('account/archived')); ?>">
						...
						<li>
							<a <?php echo ($pagePath=='messenger') ? 'class="active" ' : ''; ?>href="<?php echo e(url('account/messages')); ?>">
							<i class="icon-mail-1"></i> <?php echo e(t('messenger')); ?>&nbsp;
							<span class="badge badge-pill count-threads-with-new-messages hide">0</span>
							</a>
						</li>
						<li>
							<a<?php echo ($pagePath=='transactions') ? ' class="active"' : ''; ?> href="<?php echo e(url('account/transactions')); ?>">
						...
						<?php if(config('plugins.api.installed')): ?>
							<li>
								<a<?php echo ($pagePath=='api-dashboard') ? ' class="active"' : ''; ?> href="<?php echo e(url('account/api-dashboard')); ?>">
			...
			<div class="collapse-box">
				...
				<div class="panel-collapse collapse show" id="TerminateAccount">
					<ul class="acc-list">
						<li>
							<a <?php echo ($pagePath=='close') ? 'class="active"' : ''; ?> href="<?php echo e(url('account/close')); ?>">
	...
	<!-- /.inner-box  -->
</aside><?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/account/inc/sidebar.blade.php ENDPATH**/ ?>