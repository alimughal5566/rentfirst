                                ...
                                <div class="col-md-9 col-lg-10">
                                    ...
                                    <div class="btn-group hidden-sm">
                                        ...
                                        <ul id="groupedAction" class="dropdown-menu dropdown-menu-sort" role="menu">
                                            ...
                                            <li class="dropdown-item">
                                                <a href="<?php echo e(url('account/messages/actions?type=delete')); ?>">
                                                    <?php echo e(t('Delete')); ?>
                                    ...
                                    <button type="button" id="btnRefresh" class="btn btn-secondary hidden-sm" data-toggle="tooltip" title="<?php echo e(t('refresh')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/account/messenger/index.blade.php ENDPATH**/ ?>