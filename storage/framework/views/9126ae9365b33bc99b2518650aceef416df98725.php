...
<?php echo $__env->renderComponent(); ?>
    ...
    <?php $__env->slot('footer'); ?>
        <?php $__env->startComponent('mail::footer'); ?>
            © <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. <?php echo app('translator')->get('mail.All rights reserved.'); ?>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/vendor/mail/text/message.blade.php ENDPATH**/ ?>