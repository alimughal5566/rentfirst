		...
		<div class="col-xl-12">
			<div class="row pl-2 pr-2">
				<?php $__currentLoopData = $customFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<div class="detail-line col-xl-12 pb-2 pl-1 pr-1">
							<div class="rounded-small ml-0 mr-0 p-2">
								...
								<span class="detail-line-value">
									<a class="btn btn-default" href="<?php echo e(fileUrl($field->default_value)); ?>" target="_blank">
					...
					<?php else: ?>
						<?php if(!is_array($field->default_value) and $field->type != 'video'): ?>
							<?php if($field->type == 'url'): ?>
								<div class="detail-line col-sm-6 col-xs-12 pb-2 pl-1 pr-1">
									<div class="rounded-small p-2">
										...
										<span class="detail-line-value">
											<a href="<?php echo e(addHttp($field->default_value)); ?>" target="_blank" rel="nofollow"><?php echo e(addHttp($field->default_value)); ?></a>
										</span>
									</div>
								</div>
							<?php else: ?>
								<div class="detail-line col-sm-6 col-xs-12 pb-2 pl-1 pr-1">
									<div class="rounded-small p-2">
										<span class="detail-line-label"><?php echo e($field->name); ?></span>
										<span class="detail-line-value"><?php echo e($field->default_value); ?></span>
									</div>
								</div>
							<?php endif; ?>
						<?php elseif(!is_array($field->default_value) and $field->type == 'video'): ?>
							<div class="detail-line col-xl-12 pb-2 pl-1 pr-1">
								<div class="rounded-small p-2">
						...
						<?php else: ?>
							<?php if(count($field->default_value) > 0): ?>
							<div class="detail-line col-xl-12 pb-2 pl-1 pr-1">
								<div class="rounded-small p-2">
									<span><?php echo e($field->name); ?>:</span>
									<div class="row m-0 p-2">
										<?php $__currentLoopData = $field->default_value; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $valueItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/post/inc/fields-values.blade.php ENDPATH**/ ?>