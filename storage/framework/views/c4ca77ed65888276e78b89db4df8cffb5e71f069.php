	...
	<div class="card border-top border-primary shadow-sm">
		<div class="card-body">
			...
			<div class="d-md-flex">
				...
				<div class="ml-auto">
					<a href="<?php echo e(url('posts/create')); ?>" target="_blank" class="btn btn-sm btn-light rounded shadow pull-left">
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/vendor/admin/dashboard/inc/latest-posts.blade.php ENDPATH**/ ?>