		...
		<div class="scroll-sidebar">
			...
			<nav class="sidebar-nav">
				<ul id="sidebarnav">
					...
					<?php if(
						...
						<li class="sidebar-item">
							...
							<ul aria-expanded="false" class="collapse first-level">
								...
								<?php if(auth()->user()->can('category-list') || userHasSuperAdminPermissions()): ?>
									<li class="sidebar-item">
										<a href="<?php echo e(admin_url('limit-package')); ?>" class="sidebar-link">
											<i class="mdi mdi-adjust"></i>
											<span class="hide-menu">Packages for Post</span>
										</a>
									</li>
								<?php endif; ?>
						...
						<li  class="sidebar-item">
							...
							<ul aria-expanded="false" class="collapse first-level">
								...
								<?php endif; ?>
									...
									<?php if(auth()->user()->can('setting-list') || userHasSuperAdminPermissions()): ?>
										<li class="sidebar-item">
											<a href="<?php echo e(route('footr-banner')); ?>" class="sidebar-link">
												<i class="mdi mdi-adjust"></i>
												<span class="hide-menu">Footer banner</span>
											</a>
										</li>
									<?php endif; ?>
							</ul>
					...
					<?php endif; ?>
					<?php if(auth()->user()->can('home-banner') || userHasSuperAdminPermissions()): ?>
						<li class="sidebar-item">
							<a href="<?php echo e(route('home-banner')); ?>" class="sidebar-link">
...
<?php endif; ?>
<?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/vendor/admin/layouts/inc/sidebar.blade.php ENDPATH**/ ?>