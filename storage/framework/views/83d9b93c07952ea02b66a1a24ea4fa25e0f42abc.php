				...
				<div class="form-group row <?php echo e($requiredClass); ?>" style="margin-top: -10px;">
					...
					<div class="col-md-8"<?php echo $cmFieldStyle; ?>>
						<?php $__currentLoopData = $field->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							...
							?>
							<div class="form-check pt-2">
								<input id="<?php echo e($fieldId . '.' . $option->id); ?>"
									   name="<?php echo e($fieldName . '[' . $option->id . ']'); ?>"
									   value="<?php echo e($option->id); ?>"
									   type="checkbox"
									   class="form-check-input<?php echo e($errorClass); ?>"
										<?php echo e(($defaultValue == $option->id) ? 'checked="checked"' : ''); ?>

								>
								<label class="form-check-label" for="<?php echo e($fieldId . '.' . $option->id); ?>">
		...
		<?php elseif($field->type == 'file'): ?>
			...
			<div class="form-group row <?php echo e($requiredClass); ?>">
				...
				<div class="col-md-8">
					...
					<?php if(!empty($field->default_value) and $disk->exists($field->default_value)): ?>
						<div>
			...
			<div class="form-group row <?php echo e($requiredClass); ?>">
				...
				<div class="col-md-8">
					...
					<select id="<?php echo e($fieldId); ?>" name="<?php echo e($fieldName); ?>" class="form-control <?php echo e($select2Type . $errorClass); ?>">
						<option value="<?php echo e($field->default_value); ?>"
								<?php if(old($fieldOld)=='' or old($fieldOld)==$field->default_value): ?>
									selected="selected"
								<?php endif; ?>
						>
...
<?php /**PATH /home1/hasaanmalik/rentfirst.ivylabtech.com/resources/views/post/inc/fields.blade.php ENDPATH**/ ?>